...
/**
 * Builds an even shell and has no recursion
 *
 * @since 1.0.0
 * @author Actually Portals
 */
public class ASIGCEvenShell extends ASIGCubeConstructor {
     ...
     * @since 1.0.0
     */
    public ASIGCEvenShell(int s, @NotNull Vec3 origin) { super(s, origin); }
    ...
    @Override public @NotNull ArrayList<Vec3> elaborate(int depth, int limit) {
        ...
        // Just a 2x2x2 consists only of corners
        if (getGridScale() == 2) { return ret; }
